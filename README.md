# Fedora-Mail-in-a-Box

This is a port the Mail-in-a-Box project from Ubuntu to Fedora Server. The home page of the original Ubuntu project is [here](https://mailinabox.email) and the code on Github is [here](https://github.com/mail-in-a-box/mailinabox).

Current development status/log is [here.](dev-status.md)

The goals of this project are exactly the same as the original project
...
For more information on how Fedora-Mail-in-a-Box handles your privacy, see the [security details page](security.md).
